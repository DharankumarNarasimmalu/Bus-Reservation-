...
public class Main {
	...
	public static void main(String...args) {
		...
		List<LoginUser>customerLogin=new ArrayList<>();
		LoginUser user1=new LoginUser("Dharan",20,"149,K........cuddalore",9876543201l,"dharan@gmail.com","1234");
		LoginUser user2=new LoginUser("Kumar",19,"148,K........chennai",10234567894l,"kumar@gmail.com","4321");
		LoginUser user3=new LoginUser("Karthic",21,"150,K........coimbatore",9876543201l,"karthic@gmail.com","9876");
		...
		driverDetails.put(1,new Driver("Surya",20,9876543201l,"rahul@gmail.com","149,.......cuddalore",20000,2,"good",attendence.PRESENT,123,"12:30","25/04/2022","Cuddalore","Chennai"));
		driverDetails.put(2,new Driver("Karthic",20,9876543201l,"rahul@gmail.com","149,.......cuddalore",20000,2,"good",attendence.PRESENT,124,"10:30","25/04/2022","Cuddalore","Chennai"));
		driverDetails.put(3,new Driver("Vijay",20,9876543201l,"rahul@gmail.com","149,.......cuddalore",20000,2,"good",attendence.PRESENT,124,"15:30","25/04/2022","Cuddalore","Chennai"));
		Map<Integer,Supervisor>supervisorDetails=new HashMap<>();
		supervisorDetails.put(6,new Supervisor("Rajini",20,9876543201l,"rahul@gmail.com","149,.......cuddalore",20000,2, "good",attendence.PRESENT,dutyCycle.DAY));
			    	...
			    	while(true) {
			    	    ...
			    	    if(password.equals(confirmPassword)){
			    		    ...
			    		    if(phoneNumberVerify==phNo && mailId.equals(mail)) {
			    			    ...
			    			    user.iamNotRobot();
			    			    customerLogin.add(new LoginUser(name,age,address,phNo,mailId,password));	
			    			    break;
			    		    }
			    		    else {
			    ...
			    case(11)://add employee
			        ...
			        if(newPassword.equals(confirmPassword)) {
				        ...
				        switch(employeeOption) {
				            case(1):
				            	driverDetails.put(driverDetails.size()+1, new Driver(employeeName,employeeAge,phoneNumber,mailId,employeeAddress,salary,exp,"good",attendence.PRESENT,busNo,"time","date","from","to"));
				                break;
				            case(2):
				            	supervisorDetails.put(supervisorDetails.size()+driverDetails.size()+1,new Supervisor(employeeName,employeeAge,phoneNumber,mailId,employeeAddress,salary,exp,"good",attendence.PRESENT, dutyCycle.DAY));
				            	break;
				            default:
				            	System.out.println("INVALID OPTION");
				        }
